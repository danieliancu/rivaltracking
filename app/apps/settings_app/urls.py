...
urlpatterns = [
    ...
    path("catalogue/website-panel/", views.catalogue_website_panel, name="catalogue_website_panel"),
    path("catalogue/import-status/", views.import_status, name="import_status"),
