...
export const priceTrend = [
  {date:'Apr 23',median:1.8,average:2.6},{date:'Apr 26',median:.9,average:1.7},
  {date:'Apr 30',median:-.6,average:.5},{date:'May 3',median:-2.1,average:-1.1},
  {date:'May 7',median:-3.8,average:-2.7},{date:'May 10',median:-5.2,average:-4},
  {date:'May 14',median:-6.5,average:-5.3},{date:'May 17',median:-7.3,average:-6.1},
  {date:'May 21',median:-8.4,average:-7}
]
export const categories = [
  {name:'Outdoor Toys',value:62},{name:'Educational Toys',value:38},{name:'Baby Toys',value:27},
  {name:'Personalised Toys',value:22},{name:'Plush Toys',value:18}
]
export const stock = [
...
export const discoveries = [
  {name:'PlayNest.co.uk',match:91,tone:'blue'},{name:'HappyToyHouse.com',match:88,tone:'purple'},
  {name:'LittleMindsToys.co.uk',match:85,tone:'teal'},{name:'BrightKidsPlay.com',match:82,tone:'orange'}
]
...
export type OverviewDataset = {
  kpis: readonly (readonly [string, string, string, string])[]
  priceTrend: { date: string; median: number; average: number }[]
  categories: { name: string; value: number }[]
  stock: { name: string; value: number; percent: string; color: string }[]
  totalProducts: string
}

export const overviewByRange: Record<RangeKey, OverviewDataset> = {
  '30d': { kpis, priceTrend, categories, stock, totalProducts: '2,438' },
  '7d': {
    kpis: [
      ['monitored','Products monitored','2,438','info'],
    ...
    priceTrend: [
      {date:'May 15',median:-6.8,average:-5.6},{date:'May 16',median:-7.0,average:-5.8},
      {date:'May 17',median:-7.3,average:-6.1},{date:'May 18',median:-7.6,average:-6.3},
      {date:'May 19',median:-7.9,average:-6.6},{date:'May 20',median:-8.2,average:-6.8},
      {date:'May 21',median:-8.4,average:-7}
    ],
    categories: [
      {name:'Outdoor Toys',value:58},{name:'Educational Toys',value:41},{name:'Baby Toys',value:22},
      {name:'Personalised Toys',value:17},{name:'Plush Toys',value:12}
    ],
    stock: [
  ...
  today: {
    ...
    priceTrend: [
      {date:'08:00',median:-8.1,average:-6.8},{date:'09:00',median:-8.1,average:-6.9},
      {date:'10:00',median:-8.2,average:-6.9},{date:'11:00',median:-8.3,average:-7},
      {date:'12:00',median:-8.4,average:-7},{date:'13:00',median:-8.4,average:-7},
      {date:'14:00',median:-8.4,average:-7}
    ],
    categories: [
      {name:'Outdoor Toys',value:64},{name:'Educational Toys',value:31},{name:'Baby Toys',value:12},
      {name:'Personalised Toys',value:8},{name:'Plush Toys',value:6}
    ],
    stock: [
